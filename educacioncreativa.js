...
const users = {
    ...
    "7149": "Elida León Sánchez",    //Instructor
    "1036": "Milciades León Sánchez",
    "4895": "Alejandro León Buitrago",  
...
let classes = [
    {
        title: "Ortografía y literatura",
        description: "Como tener una buena ortografia, que libro son recomendados.. ",
        resources: [],
    },
    {
        title: "Como entender mejor las matematicas",
        description: "Como podemos entenderlas mejor, consejos, tips. Etc",
        resources: [],
    },
];
...
document.getElementById("login-form").addEventListener("submit", (e) => {
    ...
    if (users[pin]) {
        currentUser = { name: users[pin], role: pin === "7149" ? "instructor" : "student" };
