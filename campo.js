...
const users = {
    ...
    "8547": "Marlenny León Sánchez",   //Instructor
...
let classes = [
    {
        title: "Pasos para sembrar: Yuca, Papa, Platano, Aracacha",
        description: "Que necesitamos para sembrar ¨legumbre¨",
        resources: [],
    },
    {
        title: "Cafe y Cacao",
        description: "Como sabemos cuando el Cacao y el Cafe, esta listo para recoger: Como se recolecta:",
        resources: [],
    },
];
...
document.getElementById("login-form").addEventListener("submit", (e) => {
    ...
    if (users[pin]) {
        currentUser = { name: users[pin], role: pin ===  "8547"? "instructor": "student" };  
