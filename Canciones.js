...
let classes = [
    {
        title: "Introducción a la Composición Musical",
        description: "Conceptos básicos sobre cómo funciona la música y la teoría musical.",
        resources: [],
    },
    {
        title: "Teoría Musical Básica",
        description: "Aprenderemos las notas musicales, escalas y acordes.",
        resources: [],
    },
];
